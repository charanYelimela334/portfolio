...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const roles = ['Python Developer', 'ML Enthusiast', 'Data Analyst'];
    let currentRoleIndex = 0;
    let currentCharIndex = 0;
    let isDeleting = false;
    let typingSpeed = 75; // Increased speed for a more natural feel
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-16 bg-gradient-to-br from-white to-gray-100">
      <div className="container mx-auto px-4 py-16 flex flex-col md:flex-row items-center justify-between">
        ...
        >
          ...
          <div className="flex space-x-6">
            <a 
              href="https://www.linkedin.com/in/charan-yelimela" 
              target="_blank" 
        ...
        >
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            <Image
              src="/images/profile.jpg" // Make sure to add your image to this path
              alt="Charan Yelimela"
              fill
